...
<META name=GENERATOR content="MSHTML 8.00.7601.17514">
  <script language="JavaScript" type="text/javascript" src="../scripts/js/jquery-1.8.3.js"></script>
  <script language="JavaScript">
      $(function(){  //加载事件
          ...
          $.post("selectTypeAll",null,function (data) {
              ...
              //设置选中项
              $("#type_id").val(${houseCondition.tid});
          },"json");
          ...
          $.post("selectDistrictAll",null,function (data) {
              ...
              //设置选中项
              $("#district_id").val(${houseCondition.did});
          ...
          function loadStreet(){
              ...
              if(did!="") {
                  ...
                  $.post("selectStreetAllByDid", {"did": did}, function (data) {
                      ...
                      //设置选中项
                      $("#street_id").val(${houseCondition.sid});
                  }, "json");
              }
          }
...
<DL class="search clearfix">
  <FORM id=sform method=post action=getHouseByCondition>
    ...
    价格:<input type="tex" name="startPrice" size="8" value="${houseCondition.startPrice}">-<input name="endPrice" type="text" size="8" value="${houseCondition.endPrice}">
...
<TABLE class=house-list>
  ...
  <TR>
    <TD class=house-thumb><span><A href="#" target="_blank"><img src="../images/thumb_house.gif" width="100" height="75" alt=""></a></span></TD>
    <TD>
      <DL>
        <DT><A href="getHouse?id=${h.id}" target="_blank">${h.title}</A></DT>
